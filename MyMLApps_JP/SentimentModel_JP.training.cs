...
namespace MyMLApps_JP
{
    public partial class SentimentModel_JP
    {
        public const string RetrainFilePath =  @"C:\Users\wsosc\Prog\CSharp\repos\MyMLApps\MyMLApps_JP\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.4602641F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
