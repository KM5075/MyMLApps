...
namespace MyMLApps
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\wsosc\Prog\CSharp\repos\MyMLApps\MyMLApps\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastForest(new FastForestBinaryTrainer.Options(){NumberOfTrees=10,NumberOfLeaves=21,FeatureFraction=0.4403387F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName:@"col1"))      
