...
namespace PredictiveMaintenance
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\wsosc\Prog\CSharp\repos\MyMLApps\PredictiveMaintenance\ai4i+2020+predictive+maintenance+dataset\ai4i2020.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"Type", @"Type", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=4,MinimumExampleCountPerLeaf=21,LearningRate=0.5949138884316493,LabelColumnName=@"Machine failure",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.99999999,L1Regularization=2.7650142875650883E-10,L2Regularization=0.8032134528720934},MaximumBinCountPerFeature=190}))      
